            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1 fs-8">
                        ...
                        <li class="breadcrumb-item active text-primary fw-semibold" aria-current="page">Students</li>
                    </ol>
                </nav>
                <h4 class="fw-bold mb-0 text-dark d-flex align-items-center gap-2">
                    <i class="bi bi-person-lines-fill text-primary"></i> Student Directory
                </h4>
                <p class="text-muted fs-7 mb-0">Manage student profiles, enrollment statuses, and academic records.</p>
            </div>
            <div class="d-flex gap-2 mt-3 mt-md-0">
                <button type="button"
                    class="btn btn-outline-secondary btn-sm d-flex align-items-center gap-1.5 rounded-2 px-3 fw-medium">
                ...
                <table class="table align-middle table-hover mb-0">
                    ...
                    <tbody class="border-top-0 fs-7">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2.5">
                                    <div class="avatar-circle bg-primary text-white fw-bold d-flex align-items-center justify-content-center rounded-circle fs-8"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2.5">
                                    <div class="avatar-circle bg-info text-white fw-bold d-flex align-items-center justify-content-center rounded-circle fs-8"
                                        style="width: 36px; height: 36px;">
                                        JT
                                    </div>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2.5">
                                    <div class="avatar-circle bg-warning text-white fw-bold d-flex align-items-center justify-content-center rounded-circle fs-8"
                                        style="width: 36px; height: 36px;">
                                        JD
                                    </div>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2.5">
                                    <div class="avatar-circle bg-purple text-white fw-bold d-flex align-items-center justify-content-center rounded-circle fs-8"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2.5">
                                    <div class="avatar-circle bg-danger text-white fw-bold d-flex align-items-center justify-content-center rounded-circle fs-8"
                                        style="width: 36px; height: 36px;">
                                        AW
                                    </div>
                                    <div>
